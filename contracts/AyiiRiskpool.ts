...
export interface AyiiRiskpoolInterface extends utils.Interface {
  functions: {
    ...
    "SUM_OF_SUM_INSURED_CAP()": FunctionFragment;
    ...
    "grantInvestorRole(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SUM_OF_SUM_INSURED_CAP",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "grantInvestorRole",
...
export interface AyiiRiskpool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AyiiRiskpoolInterface;
  ...
  functions: {
    ...
    SUM_OF_SUM_INSURED_CAP(overrides?: CallOverrides): Promise<[BigNumber]>;

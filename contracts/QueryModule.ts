...
export interface QueryModuleInterface extends utils.Interface {
  functions: {
    "cancel(uint256)": FunctionFragment;
    "getOracleRequestCount()": FunctionFragment;
    "getProcessId(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOracleRequestCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface QueryModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QueryModuleInterface;
  ...
  getOracleRequestCount(overrides?: CallOverrides): Promise<BigNumber>;

...
export interface RegistryControllerInterface extends utils.Interface {
  functions: {
...
export interface RegistryController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RegistryControllerInterface;

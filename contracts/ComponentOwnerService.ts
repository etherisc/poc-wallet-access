...
export interface ComponentOwnerServiceInterface extends utils.Interface {
  functions: {
...
export interface ComponentOwnerService extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComponentOwnerServiceInterface;

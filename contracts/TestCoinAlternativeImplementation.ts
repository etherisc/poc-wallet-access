...
export interface TestCoinAlternativeImplementationInterface
...
export interface TestCoinAlternativeImplementation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCoinAlternativeImplementationInterface;

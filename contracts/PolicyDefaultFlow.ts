...
export interface PolicyDefaultFlowInterface extends utils.Interface {
  functions: {
    ...
    "getApplicationData(bytes32)": FunctionFragment;
    "getClaimData(bytes32,uint256)": FunctionFragment;
    "getContractFromRegistry(bytes32)": FunctionFragment;
    "getPayoutData(bytes32,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getApplicationData",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface PolicyDefaultFlow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PolicyDefaultFlowInterface;
  ...
  functions: {
    ...
    request(
      ...
      _callbackMethodName: PromiseOrValue<string>,
      _callbackContractAddress: PromiseOrValue<string>,
      _responsibleOracleId: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
